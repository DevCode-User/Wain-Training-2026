...
import com.example.ec.dto.LoginForm;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public String loginCustomer(@Valid @ModelAttribute("loginForm") LoginForm form,
    ...
    public String registerCustomer(@Valid @ModelAttribute("registerForm") RegisterForm form,
                                   BindingResult bindingResult,
                                   Model model,
    ...
    public String loginAdmin(@Valid @ModelAttribute("loginForm") LoginForm form,
                             BindingResult bindingResult,
                             HttpSession session,
                             Model model) {
        if (bindingResult.hasErrors()) {
    ...
    public String adminHome(HttpSession session, Model model) {
        if (!"ADMIN".equals(session.getAttribute("LOGIN_ROLE"))) {
